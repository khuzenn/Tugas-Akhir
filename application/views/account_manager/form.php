            ...
            <div class="col-xxl-12">
                ...
                <div class="alert alert-dismissible bg-light-warning d-flex flex-column flex-sm-row w-100 p-5 mb-3">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        ...
                        <span>Gagal menambahkan data account manager</span>
                    </div>
                    <!--end::Content-->
                    <!--begin::Close-->
        ...
        <div class="col-xxl-12">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-5 pb-3">
                    <!--begin::Card title-->
                    <h3 class="card-title fw-bolder text-gray-800 fs-2">Form Account Manager</h3>
                    <!--end::Card title-->
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <form class="form-horizontal" role="form" action="<?php echo $action; ?>" method="POST">
                    <div class="card-body pt-0">
                        <div class="mb-3 row">
                            <label for="inputPassword" class="col-sm-3 col-form-label text-end">Nama Account Manager<span style="color:red;">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nama_am" placeholder="Nama Account Manager" autocomplete="off" value="<?php if (isset($nama_am)) {
                                                                                                                                                            echo $nama_am;
                                                                                                                                                        } ?>">
                                <span style="color: red;"><?php echo form_error('nama_am'); ?></span>
                            </div>
                        </div>
                    </div>
