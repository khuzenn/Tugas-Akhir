        ...
        <div class="col-xxl-12">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-5 pb-3">
                    <!--begin::Card title-->
                    <h3 class="card-title fw-bolder text-gray-800 fs-2">List Data Account Manager</h3>
                    <!--end::Card title-->
                    <!--begin::Button-->
                    <a href="<?php echo site_url('account-manager/tambah'); ?>" class="btn btn-success btn-sm my-2" tooltip="Tambah Segmen">Tambah Account</a>
                    <!--end::Button-->
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body pt-0">
                    ...
                    <table id="kt_datatable_example_lini_bisnis" class="table table-striped table-row-bordered table-rounded table-striped table-hover border gy-5 gs-7">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($listAm as $key => $am) {
                            ?>
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><?php echo $am->nama_am; ?></td>
                                    <td>
                                        <a href="<?php echo site_url('account-manager/sunting/' . encrypt_url($am->id_am)); ?>" class="btn btn-primary btn-sm">Sunting</a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
